    ...
    @testset "gcd/lcm" begin
        ...
        @testset "gcdx" begin
            for T in (halfinttypes..., halfuinttypes...)
                ...
                @eval @test ((d,u,v) = gcdx(3, $T(3/2)); u*3 + v*$T(3/2) == d == 3/2)
                @eval @test ((d,u,v) = gcdx(3, $T(9/2)); u*3 + v*$T(9/2) == d == 3/2)
                @eval @test ((d,u,v) = gcdx($T(3/2), 1); u*$T(3/2) + v*1 == d == 1/2)
                @eval @test ((d,u,v) = gcdx($T(3/2), 2); u*$T(3/2) + v*2 == d == 1/2)
            ...
            @test ((d,u,v) = gcdx(BigHalfInt(1), BigHalfInt(3/2)); u*1 + v*BigHalfInt(3/2) == d == 1/2)
            @test ((d,u,v) = gcdx(BigHalfInt(2), BigHalfInt(3/2)); u*2 + v*BigHalfInt(3/2) == d == 1/2)
            @test ((d,u,v) = gcdx(BigHalfInt(3), BigHalfInt(3/2)); u*3 + v*BigHalfInt(3/2) == d == 3/2)
            @test ((d,u,v) = gcdx(BigHalfInt(3), BigHalfInt(9/2)); u*3 + v*BigHalfInt(9/2) == d == 3/2)
            @test ((d,u,v) = gcdx(BigHalfInt(3/2), BigHalfInt(3/2)); u*BigHalfInt(3/2) + v*BigHalfInt(3/2) == d == 3/2)
            @test ((d,u,v) = gcdx(1, BigHalfInt(3/2)); u*1 + v*BigHalfInt(3/2) == d == 1/2)
            @test ((d,u,v) = gcdx(2, BigHalfInt(3/2)); u*2 + v*BigHalfInt(3/2) == d == 1/2)
            @test ((d,u,v) = gcdx(3, BigHalfInt(3/2)); u*3 + v*BigHalfInt(3/2) == d == 3/2)
            @test ((d,u,v) = gcdx(3, BigHalfInt(9/2)); u*3 + v*BigHalfInt(9/2) == d == 3/2)
            @test ((d,u,v) = gcdx(BigHalfInt(3/2), 1); u*BigHalfInt(3/2) + v*1 == d == 1/2)
            @test ((d,u,v) = gcdx(BigHalfInt(3/2), 2); u*BigHalfInt(3/2) + v*2 == d == 1/2)
            @test ((d,u,v) = gcdx(BigHalfInt(3/2), 3); u*BigHalfInt(3/2) + v*3 == d == 3/2)
            @test ((d,u,v) = gcdx(BigHalfInt(9/2), 3); u*BigHalfInt(9/2) + v*3 == d == 3/2)
            @test ((d,u,v) = gcdx(BigHalfInt(-5/2), BigHalfInt(3/2)); u*BigHalfInt(-5/2) + v*BigHalfInt(3/2) == d == 1/2)
        end
    end
